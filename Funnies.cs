namespace Funnies
{
    public static class Funnies
    {
        ...
        public static string GetPaddedLine()
        {
            ...
            return newline + GetLine() + newline;
        }

        private static string FormattingRoot => System.Runtime.InteropServices.RuntimeInformation.IsOSPlatform(System.Runtime.InteropServices.OSPlatform.Windows) ? "Formatting C:\\" : "Formatting /";
        

        private static readonly string[] LINES = new[] {
            "Clearing out the sporophytes...",
            "A rotating cog amasses no sporophytes",
            ...
            "Chuck Norris never does a git push. The repo pulls before.",
            ...
            "Please hold on as we convert this bug to a feature...",
            "Please hold on as our intern attempts to close vim...",
            "Winter is coming...",
            ...
            "Please wait, while we purge the Decepticons",
            ...
            "We didn't have enough fuel for an earlier departure."
            };
    }
}
